...
from fake_stake.base_test import PowerCash_FakeStakeTest

class zPRCHwrappedSerialsTest(PowerCash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPRCHs..." % DENOM_TO_USE)
