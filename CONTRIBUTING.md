Contributing to PowerCash Core
============================

The PowerCash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/powercash-project/powercash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PowerCash Core project, and is not to be
confused with overall PowerCash Network Protocol consensus changes.

Whether a pull request is merged into PowerCash Core rests with the project merge
...
Patches that change PowerCash consensus rules are considerably more involved than
...
Where a patchset proposes to change the PowerCash consensus, it must have been
...
The project leader is the release manager for each PowerCash Core release.
