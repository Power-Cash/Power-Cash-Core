...
This document provides guidelines for internationalization of the PowerCash Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to PowerCash network</numerusform>
            <numerusform>%n active connections to PowerCash network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `powercash_en.ts` remains unchanged.
