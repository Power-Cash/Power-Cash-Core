...
/** Utility functions used by the PowerCash Qt UI.
 */
namespace GUIUtil
{
...
// Render PowerCash addresses in monospace font
...
// Parse "powercash:" URI into recipient object, return true on successful parsing
