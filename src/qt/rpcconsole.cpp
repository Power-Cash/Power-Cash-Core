                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPRCHPathCustom = GetArg("-zprchbackuppath", "");
    ...
    if(!strzPRCHPathCustom.empty()) {
        ui->wallet_customzprchbackuppath->setText(QString::fromStdString(strzPRCHPathCustom));
        ui->wallet_customzprchbackuppath_label->setVisible(true);
        ui->wallet_customzprchbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPRCHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PowerCash RPC console.") + "<br>" +
