...
/* PowerCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PowerCash"
#define QAPP_ORG_DOMAIN "powercash.org"
#define QAPP_APP_NAME_DEFAULT "PowerCash-Qt"
#define QAPP_APP_NAME_TESTNET "PowerCash-Qt-testnet"
