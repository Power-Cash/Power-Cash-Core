...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PowerCash Core"),
     ...
     * override -datadir in the powercash.conf file in the default data directory
     * (to be consistent with powercashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
