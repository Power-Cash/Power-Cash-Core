...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PRCH);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePowerCashAmount"))
        SoftSetArg("-anonymizepowercashamount", settings.value("nAnonymizePowerCashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in powercash.cpp during shotdown to also remove the window positions
