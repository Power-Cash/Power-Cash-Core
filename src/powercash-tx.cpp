...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PowerCash Core powercash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  powercash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded powercash transaction") + "\n" +
                               "  powercash-tx [options] -create [commands]   " + _("Create hex-encoded powercash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded powercash transaction
