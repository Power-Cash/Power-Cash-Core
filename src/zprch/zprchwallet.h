...
#ifndef PowerCash_ZPRCHWALLET_H
#define PowerCash_ZPRCHWALLET_H
...
public:
    CzPRCHWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPRCH(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPRCH(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
