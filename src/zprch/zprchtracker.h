...
#ifndef PowerCash_ZPRCHTRACKER_H
#define PowerCash_ZPRCHTRACKER_H
...
public:
    CzPRCHTracker(std::string strWalletFile);
    ~CzPRCHTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPRCHWallet* zPRCHWallet = NULL);
...
#endif //PowerCash_ZPRCHTRACKER_H
