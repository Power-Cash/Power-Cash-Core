...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PowerCash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "PowerCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PowerCash features */
        {"powercash", "listmasternodes", &listmasternodes, true, true, false},
        {"powercash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"powercash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"powercash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"powercash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"powercash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"powercash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"powercash", "masternodedebug", &masternodedebug, true, true, false},
        {"powercash", "startmasternode", &startmasternode, true, true, false},
        {"powercash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"powercash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"powercash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"powercash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"powercash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"powercash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"powercash", "preparebudget", &preparebudget, true, true, false},
        {"powercash", "submitbudget", &submitbudget, true, true, false},
        {"powercash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"powercash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"powercash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"powercash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"powercash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"powercash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"powercash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"powercash", "checkbudgets", &checkbudgets, true, true, false},
        {"powercash", "mnsync", &mnsync, true, true, false},
        {"powercash", "spork", &spork, true, true, false},
        {"powercash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzprchseed", &getzprchseed, false, false, true},
        {"zerocoin", "setzprchseed", &setzprchseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzprch", &searchdzprch, false, false, true},
        {"zerocoin", "dzprchstate", &dzprchstate, false, false, true},
...
{
    return "> powercash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41147/\n";
}
