...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/powercash-cli.cpp \
           src/powercash-tx.cpp \
           src/powercash.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/powercash.qrc src/qt/powercash_locale.qrc

TRANSLATIONS += src/qt/locale/powercash_bg.ts \
                src/qt/locale/powercash_de.ts \
                src/qt/locale/powercash_en.ts \
                src/qt/locale/powercash_es.ts \
                src/qt/locale/powercash_fi.ts \
                src/qt/locale/powercash_fr.ts \
                src/qt/locale/powercash_it.ts \
                src/qt/locale/powercash_ja.ts \
                src/qt/locale/powercash_pl.ts \
                src/qt/locale/powercash_pt.ts \
                src/qt/locale/powercash_ru.ts \
                src/qt/locale/powercash_sk.ts \
                src/qt/locale/powercash_sv.ts \
                src/qt/locale/powercash_vi.ts \
                src/qt/locale/powercash_zh_CN.ts \
                src/qt/locale/powercash_zh_TW.ts
